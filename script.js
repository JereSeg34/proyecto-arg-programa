...
function efectoHabilidades(){
    ...
    if(distancia_skills >= 300){
        document.getElementById("adaptacion").classList.add("barra-progreso1");
        document.getElementById("trabajo").classList.add("barra-progreso2");
        document.getElementById("resolucion").classList.add("barra-progreso3");
